      ...
      <div className={styles.card}>
        ...
        <div className={styles.faqs}>
          ...
          {[
            ...
            { q: "Comment fonctionne le système d'XP ?", a: "Tu gagnes +5 XP par histoire lue, +4 XP par mini-jeu réussi (+2 XP si raté), et +1 XP par bonne réponse au quiz du jour (0 XP si faux). Les séries donnent des bonus : +10 XP à 3 jours, +15 XP à 5 jours, +25 XP à 10 jours, +50 XP à 30 jours. Les jeux Premium ne donnent pas d'XP." },
