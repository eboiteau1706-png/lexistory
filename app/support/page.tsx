      ...
      <div className={styles.card}>
        ...
        <div className={styles.faqs}>
          ...
          {[
            ...
            { q: "Comment fonctionne le système d'XP ?", a: "Tu gagnes +5 XP par histoire lue. Les jeux du jour rapportent +4 XP par jeu réussi. Les séries donnent des bonus : +10 XP à 3 jours, +15 XP à 5 jours, +25 XP à 10 jours, +50 XP à 30 jours. Les abonnés Premium débloquent aussi 4 jeux exclusifs supplémentaires pour s'entraîner (0 XP)." },
