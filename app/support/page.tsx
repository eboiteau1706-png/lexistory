      ...
      <div className={styles.card}>
        ...
        <div className={styles.faqs}>
          ...
          {[
            ...
            { q: "Comment fonctionne le système d'XP ?", a: "Tu gagnes +3 XP par histoire lue (+4 XP en Premium). Les jeux du jour rapportent +3 XP par jeu réussi (+4 XP Premium). Les séries de jours consécutifs donnent des bonus : +10 XP à 3 jours, +15 XP à 5 jours, +25 XP à 10 jours, +50 XP à 30 jours (x1,5 pour les Premium). Les abonnés Premium débloquent aussi 4 jeux exclusifs supplémentaires (+3 XP chacun)." },
