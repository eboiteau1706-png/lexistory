    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <section className={styles.section}>
          ...
          <p>Vos données sont stockées de façon sécurisée via <strong>Supabase</strong> (serveurs en Europe) conformément au RGPD.</p>
        </section>
        ...
        <section className={styles.section}>
          <h2>Cookies</h2>
          <p>LexiStory utilise uniquement des cookies techniques nécessaires à votre connexion. Aucun cookie publicitaire ou de tracking n&apos;est utilisé.</p>
        </section>
